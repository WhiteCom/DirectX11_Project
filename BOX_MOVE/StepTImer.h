...
namespace DX
{
    ...
    public:
        StepTimer() noexcept :
            ...
            m_targetElapsedTicks(10000000 / 60)
        {
        ...
        // call this to avoid spikes in FixedTimeStepUpdate.
        ...
        void Tick(TUpdate&& update)
        {
            ...
            // Convert QPC units to a canonical tick format. This cannot overflow due to the previous clamp.
            ...
            if (m_qpcSecondCounter >= m_qpcFrequency.QuadPart)
            {
    ...
    private:
        ...
        // Members for tracking frame rate.
